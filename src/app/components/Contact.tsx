...
const Contact = () => {
  ...
  return (
    <div id="contact" className='w-full h-full bg-gradient-to-b from-black to-gray-800 p-4 text-white '> 
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
          <form className='flex flex-col w-full md:w-1/2' ref={form} onSubmit={sendEmail} >
            ...
            <div className='p-3 my-4 bg-transparent border-2 rounded-md text-white h-28' placeholder='message confirmation' >message confirmation status:
            <p className='my-3'>
            {confirmation}
            </p>
            </div>
